...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int barCount = 0; barCount < self.numberOfBars; barCount++) {
        ...
        UIColor *green = [UIColor colorWithRed:0.65 green:0.84 blue:0.65 alpha:1.0];
        UIColor *yellow = [UIColor colorWithRed:1.00 green:0.88 blue:0.51 alpha:1.0];
        UIColor *red = [UIColor colorWithRed:0.94 green:0.60 blue:0.60 alpha:1.0];
        iColor = heightRatio < 0.5 ? red : (heightRatio < 1 ? yellow : green);
